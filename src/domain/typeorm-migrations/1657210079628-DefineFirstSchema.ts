...
export class DefineFirstSchema1657210079628 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "login" character varying NOT NULL, "password" character varying, "email" character varying NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT 'user', CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_profiles_role_enum" AS ENUM('newbie', 'subscriber', 'old-guard')`);
        await queryRunner.query(`CREATE TABLE "users_profiles" ("userId" integer NOT NULL, "userName" character varying, "phoneNumber" character varying, "role" "public"."users_profiles_role_enum" NOT NULL DEFAULT 'newbie', "avatarId" integer, CONSTRAINT "REL_1cfade2944c4f57894eb1e4af3" UNIQUE ("userId"), CONSTRAINT "PK_1cfade2944c4f57894eb1e4af34" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "games" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."admin_profiles_role_enum" AS ENUM('admin', 'super-admin', 'helper')`);
