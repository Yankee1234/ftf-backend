...
export class AddStripeAndNotificationEntities1657537313747
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "notifications" ("id" SERIAL NOT NULL, "message" text NOT NULL, "createdAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "readAt" TIMESTAMP, CONSTRAINT "PK_6a72c3c0f683f6462415e653c3a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payment_methods_pmtype_enum" AS ENUM('card')`,
    );
    await queryRunner.query(
      `CREATE TABLE "payment_methods" ("paymentMethodId" character varying NOT NULL, "createdAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "userId" integer NOT NULL, "pmType" "public"."payment_methods_pmtype_enum" NOT NULL DEFAULT 'card', CONSTRAINT "PK_d7f5fbb8810fd2ce0f8394b3b52" PRIMARY KEY ("paymentMethodId"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."payments_status_enum" AS ENUM('pending', 'succeeded')`,
    );
    await queryRunner.query(
      `CREATE TABLE "payments" ("stripePaymentId" character varying NOT NULL, "createdAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "status" "public"."payments_status_enum" NOT NULL, "chargeAmount" numeric(13,2) NOT NULL, "chargeCurrency" character(3) NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_28cd4ce1f32d256c2b62df53f86" PRIMARY KEY ("stripePaymentId"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "createdAt" TIMESTAMP(0) NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "games" ADD "createdAt" TIMESTAMP(0) NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users_profiles" ADD CONSTRAINT "UQ_1cfade2944c4f57894eb1e4af34" UNIQUE ("userId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users_profiles" DROP CONSTRAINT "UQ_1cfade2944c4f57894eb1e4af34"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users_games" ADD CONSTRAINT "FK_dc7c369d193aa998e9f399d5575" FOREIGN KEY ("userId") REFERENCES "users_profiles"("userId") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
