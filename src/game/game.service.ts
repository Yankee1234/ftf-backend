...
export class GameService {
    ...
    async addUserGame(req: AddUserGameRequest) {
        ...
        if(userGame) throw new InternalServerErrorException('This user game exists');
        ...
        return toUserProfileDto(await this.profilesRepo.getUserProfileById(req.userId, true));
    }
}
